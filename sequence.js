...
const poses = [
    {
        name: "Surya Namaskar<br>Classical Sun salutation",
        otherSide: false,
        description: "For warmup, repeat the sun salutation sequence a few times. " +
    ...
    },
    {
        name: "Inhale: Knee Up",
        otherSide: true,
        description: "Transfering weight to the standing leg, lift one knee to "+
    ...
    },
    {
        name: "Exhale: Twist",
        otherSide: true,
        description: "Keeping the palms together, twist over the knee that is lifted: " +
    ...
    },
    {
        ...
        otherSide: true,
        description: "Inhaling, drop the shoulders away from the ears, opening the chest. "+
    ...
    {
        name: "Trikonasana<br>Triangle",
        otherSide: true,
        description: "Make a step back, with the back foot and the hips facing the long edge of the mat. "+
    ...
    },
    {
        ...
        otherSide: true,
        description: "From standing, inhale lift the knee, exhale step back to Warrior I: the back foot "+
    ...
    },
    {
        ...
        otherSide: true,
        description:  "Transition through Warrior I to Warrior III, then look down. If you are standing on "+
